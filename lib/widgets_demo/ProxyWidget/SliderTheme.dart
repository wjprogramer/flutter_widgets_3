...
class _SliderThemeDemoState extends State<SliderThemeDemo> {
  ...
  _onUpdateOfSlider(double value) {
    setState(() {
      _sliderValue = value;
    });
  }
...
Path _downTriangle(double size, Offset thumbCenter, {bool invert = false}) {
  ...
  thumbPath
    ...
    ..lineTo(thumbCenter.dx, thumbCenter.dy - 2.0 * sign * centerHeight)
    ..lineTo(thumbCenter.dx + halfSize, thumbCenter.dy + sign * centerHeight)
    ..close();
